...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Nov-2017 às 22:27
...
--
-- Estrutura da tabela `conversion_chip`
--

CREATE TABLE `conversion_chip` (
  `id` int(11) NOT NULL,
  `date` datetime NOT NULL,
  `agreed_id` int(11) NOT NULL,
  `total` float(10,2) NOT NULL
...
--
-- Estrutura da tabela `conversion_money`
--

CREATE TABLE `conversion_money` (
  `id` int(11) NOT NULL,
  `date` datetime NOT NULL,
...
--
-- Indexes for table `conversion_chip`
--
ALTER TABLE `conversion_chip`
  ADD PRIMARY KEY (`id`),
  ADD KEY `agreed_id` (`agreed_id`);

--
-- Indexes for table `conversion_money`
--
ALTER TABLE `conversion_money`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `conversion_chip`
--
ALTER TABLE `conversion_chip`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `conversion_money`
--
ALTER TABLE `conversion_money`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
